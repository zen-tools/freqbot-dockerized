...
wBad = [u'(^|\s)(б|6)ля(\S*)', u'(\S*)(х|x)(у|y)(й|и|я|е|e)(\S*)', '(^|\s)ип(а|a)(л|ть)(\S*)', u'(^|\s)мля(\S*)', u'(^|\s)(х|x)(е|e)(р|p)(\S*)',
	...
	u'(^| )(с|c|3|з)(а|a)(е|e)пи(с|c)ь(\s|$)', u'(^| )(а|о)к(у|y)(е|e)нн(а|о)(\S*)', u'(^|\s)(с|c)(у|y)(к|k)(а|a)(\S*)']
